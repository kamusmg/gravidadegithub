---
name: command-open-pr
description: >
  Trigger this skill when the user types /open-pr or asks to perform the action: Create and open a pull request with comprehensive summary and test plan
---
