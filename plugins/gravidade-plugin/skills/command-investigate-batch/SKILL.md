---
name: command-investigate-batch
description: >
  Trigger this skill when the user types /investigate-batch or asks to perform the action: Systematic discovery through focused questions before planning (batched)
---
