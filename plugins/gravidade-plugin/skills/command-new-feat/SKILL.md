---
name: command-new-feat
description: >
  Trigger this skill when the user types /new-feat or asks to perform the action: Plan and implement a new feature following ANTIGRAVITY.md guidelines with focus on clarity, observability, security, accessibility, and performance
---
