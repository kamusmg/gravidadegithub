...
description: >
  Deep code review protocol using SOLID, DRY, KISS, YAGNI, CUPID with Defensive Programming analysis. Use when reviewing code for quality, analyzing pull requests, or auditing codebases for improvements.
---
