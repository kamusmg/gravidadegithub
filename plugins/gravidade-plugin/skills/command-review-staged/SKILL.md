---
name: command-review-staged
description: >
  Trigger this skill when the user types /review-staged or asks to perform the action: Review staged changes against ANTIGRAVITY.md guidelines
---
