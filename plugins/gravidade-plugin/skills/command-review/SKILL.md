...
name: command-review
description: >
  Trigger this skill when the user types /review or asks to perform the action: Comprehensive code review focusing on clarity, observability, security, accessibility, and performance per ANTIGRAVITY.md guidelines
---
